      ...
      <section id="faq" className="px-4 py-20 mx-auto max-w-screen-xl">
        ...
        <div className="space-y-4 mb-16 max-w-3xl mx-auto bg-white/5 p-8 rounded-xl border border-white/10">
          ...
          <FAQItem 
            ...
            answer="A. 초기에는 주당 3-5시간 정도의 투자가 권장됩니다. 브랜드 인터뷰와 전략 수립 단계에서는 조금 더 시간이 필요할 수 있지만, 시스템이 구축된 후에는 주당 2-3시간 정도로 충분한 운영이 가능합니다. 더 많은 시간을 투자할수록 결과가 더 빨리 나타날 수 있습니다. 전략 컨설팅을 선택하시면 핵심 의사결정과 실행 로드맵 정리에 집중하여 내부 리소스 투입을 최소화하면서도 성과에 직결되는 우선순위를 빠르게 설정할 수 있습니다."
          />
