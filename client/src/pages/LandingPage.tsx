      ...
      <section id="faq" className="px-4 py-20 mx-auto max-w-screen-xl">
        ...
        <div className="space-y-4 mb-16 max-w-3xl mx-auto bg-white/5 p-8 rounded-xl border border-white/10">
          ...
          <FAQItem 
            ...
            answer="A. 결제 완료 후 24시간 이내에 시작 안내와 함께 초기 설정을 도와드립니다. 티투비 챗봇은 즉시 사용 가능하며, 업그레이드 챗봇과 컨설팅 패키지는 일정 조율 후 3-5일 이내에 첫 세션이 진행됩니다. 전체 셋업은 보통 1-2주 내에 완료되어 본격적인 활용이 가능해집니다."
          />
